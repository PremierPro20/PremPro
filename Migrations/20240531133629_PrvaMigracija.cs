        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PremierProUsername = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NarudzbaID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UkupnoZaPlatiti = table.Column<double>(type: "float", nullable: false),
                    NarudzbaKupacID = table.Column<int>(type: "int", nullable: false),
                    KupacId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    DaLiJePoslano = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProizvodID = table.Column<int>(type: "int", nullable: false),
                    KorpaKupacID = table.Column<int>(type: "int", nullable: false),
                    KupacId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "ProdajaProizvoda",
                columns: table => new
                {
                    ProdajaProizvodaID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProdajaProizvoda", x => x.ProdajaProizvodaID);
                    table.ForeignKey(
                        name: "FK_ProdajaProizvoda_Proizvod_ProizvodID",
                        column: x => x.ProizvodID,
                        principalTable: "Proizvod",
                        principalColumn: "ProizvodID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProizvodNarudzbaID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProizvodNarudzba", x => x.ProizvodNarudzbaID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProdajaProizvoda_ProizvodID",
                table: "ProdajaProizvoda",
                column: "ProizvodID");
